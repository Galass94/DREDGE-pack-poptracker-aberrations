...
dredge_location = {}
dredge_location.__index = dredge_location
...
function dredge_location.new(name)
    local self = setmetatable({}, dredge_location)
    if name then
...
function dredge_location:connect_one_way(exit, rule)
...
function dredge_location:connect_two_ways(exit, rule)
...
function dredge_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function dredge_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function dredge_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function dredge_location:connect_two_ways_stuck(exit, rule1, rule2)
...
function dredge_location:accessibility()
...
-- 
function dredge_location:discover(accessibility, keys)
...
entry_point = dredge_location.new("entry_point")
